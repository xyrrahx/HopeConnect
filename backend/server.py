...
async def startup_db():
    ...
    if count == 0:
        sample_resources = [
            ...
            {"id": str(uuid.uuid4()), "name": "Safe Haven Harm Reduction", "category": "Harm Reduction", "description": "Harm reduction supplies and support - judgment-free", "address": "350 Health Street, City", "phone": "555-0118", "hours": "Mon-Fri 9AM-5PM", "lat": 40.7585, "lng": -73.9805, "services": ["Clean Supplies", "Naloxone/Narcan", "Testing Kits", "Referrals"], "created_at": datetime.now(timezone.utc).isoformat()},
            {"id": str(uuid.uuid4()), "name": "Community Health Outreach", "category": "Harm Reduction", "description": "Mobile harm reduction services", "address": "Transit Center (mobile unit), City", "phone": "555-0119", "hours": "Tue-Thu 2-6PM, Sat 10AM-2PM", "lat": 40.7552, "lng": -73.9748, "services": ["Clean Needles", "Naloxone", "Safe Disposal", "Wound Care"], "created_at": datetime.now(timezone.utc).isoformat()},
            {"id": str(uuid.uuid4()), "name": "Street Medicine Program", "category": "Harm Reduction", "description": "Free harm reduction supplies - no ID required", "address": "100 Care Lane, City", "phone": "555-0120", "hours": "Mon-Sat 10AM-6PM", "lat": 40.7625, "lng": -73.9740, "services": ["Clean Supplies", "Naloxone Training", "Fentanyl Test Strips", "Overdose Prevention"], "created_at": datetime.now(timezone.utc).isoformat()},
        ]
